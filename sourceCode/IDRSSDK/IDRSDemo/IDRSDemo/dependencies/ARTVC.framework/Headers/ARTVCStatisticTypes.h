...
@property(nonatomic,copy) NSString* googBwePacketLostRate;
...
//fec statistics
@property(nonatomic,copy) NSString* googVideoSenderFecArrivalRate;
@property(nonatomic,copy) NSString* googVideoSenderFecMediaPacketsSum;
@property(nonatomic,copy) NSString* googVideoSenderFecPacketsSum;

//NackRecvStatisticsInfo
@property(nonatomic,copy) NSString* googVideoSenderNackOptimizationEnable;
@property(nonatomic,copy) NSString* googVideoSenderRecvTotalSum;
@property(nonatomic,copy) NSString* googVideoSenderRecvFilterBeforeFecSum;
@property(nonatomic,copy) NSString* googVideoSenderRecvFilterAfterFecSum;
@property(nonatomic,copy) NSString* googVideoSenderRecvSendToPacerSum;
...
@property(nonatomic,strong) NSArray* stutters;
@property(nonatomic,assign) long long lastRenderTimestamp;

//fec statistics
@property(nonatomic,copy) NSString* googVideoRecvFecPacketsSum;
@property(nonatomic,copy) NSString* googVideoRecvFecRecoverSuccessPacketsSum;
@property(nonatomic,copy) NSString* googVideoRecvFecRecoverFailedPacketsSum;

//NackSendStatisticsInfo
@property(nonatomic,copy) NSString* googVideoRecvNackOptimizationEnable;
@property(nonatomic,copy) NSString* googVideoNackSendReceivedSeqSum;
@property(nonatomic,copy) NSString* googVideoNackSendOutOfOrderSeqSum;
@property(nonatomic,copy) NSString* googVideoNackSendOutOfOrderNoNackSeqSum;
@property(nonatomic,copy) NSString* googVideoNackSendOutOfOrderRecoveredSeqSum;
@property(nonatomic,copy) NSString* googVideoNackSendOutOfOrderRecoveredNoNackSeqSum;
@property(nonatomic,copy) NSString* googVideoNackSendOutOfOrderAverageDelayMs;
@property(nonatomic,copy) NSString* googVideoNackSendOutOfOrderMaxDelayMs;
...
@property(nonatomic,copy) NSString* googSpeechExpandRate;
@property(nonatomic,copy) NSString* googPreemptiveExpandRate;
@property(nonatomic,copy) NSString* googAccelerateRate;
@property(nonatomic,copy) NSString* googExpandRate;
@property(nonatomic,copy) NSString* googPreferredJitterBufferMs;
@property(nonatomic,copy) NSString* googDecodingPLC;
@property(nonatomic,copy) NSString* googDecodingNormal;
@property(nonatomic,copy) NSString* googDecodingMuted;
@property(nonatomic,copy) NSString* googDecodingCNG;
@property(nonatomic,copy) NSString* googDecodingPLCCNG;
@property(nonatomic,copy) NSString* googSecondaryDecodedRate;
@property(nonatomic,copy) NSString* googSecondaryDiscardedRate;
@property(nonatomic,copy) NSString* googInterruptionCounter;
@property(nonatomic,copy) NSString* googInterruptionDurationMs;
...
@interface MRTCAv1MonitorItem : NSObject
@property(nonatomic,strong) NSString* instanceId;
@property(nonatomic,assign) BOOL isPublisher;
@property(nonatomic,assign) ARTVCVideoSourceType videoSourceType;
@property(nonatomic,strong) NSNumber* cpu;
@property(nonatomic,strong) NSNumber* encodeMs;
@property(nonatomic,strong) NSNumber* decodeMs;
@property(nonatomic,strong) NSNumber* availableBandwidthKbps;
-(void)clear;
-(BOOL)invalid;
@end
#endif
