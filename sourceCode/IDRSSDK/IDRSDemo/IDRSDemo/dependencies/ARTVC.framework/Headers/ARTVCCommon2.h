...
#define ARTVCDynamicConfigFieldTrialExperimentKey @"enableFieldTrialExperiment"
#define ARTVCDynamicConfigEnableMockedCloudConfigsKey @"enableMockedCloudConfigs"
#ifdef MRTC_ENABLE_UNIFIED_PLAN
#define ARTVCDynamicConfigEnableUnifiedPlanKey @"mrtc_enable_unified_plan_key"
#endif

#ifdef MRTC_ENABLE_VIDEO_CODEC_OPTIMIZATION
#define ARTVCDynamicConfigPreferedSvcModeKey @"mrtc_prefered_svc_key"
#define ARTVCDynamicConfigMockRoomNegotiatedVideoCodecsKey @"mrtc_mock_room_negotiated_video_codecs_key"
#define ARTVCDynamicConfigMockRoomNegotiatedVideoCodecsForNewParticipantKey @"mrtc_mock_room_negotiated_video_codecs_for_new_participant_key"
#define ARTVCDynamicConfigAv1StrategyKey @"mrtc_av1_strategy_key"
#endif
#ifdef MRTC_ENABLE_WWDC21_VIDEOTOOLBOX
#define ARTVCDynamicConfigOptimizationForScreencastKey @"mrtc_optimization_for_screencast_key"
#endif
