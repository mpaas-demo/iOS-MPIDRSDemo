...
/* ADD_FOR_MRTC_END */
RTC_OBJC_EXPORT
// Camera capture that implements XRTCVideoCapturer. Delivers frames to a
// XRTCVideoCapturerDelegate (usually XRTCVideoSource).
NS_EXTENSION_UNAVAILABLE_IOS("Camera not available in app extensions.")
@interface RTC_OBJC_TYPE (XRTCCameraVideoCapturer) : RTC_OBJC_TYPE(XRTCVideoCapturer)
/* ADD_FOR_MRTC_BEGIN */
