...
#pragma mark - e2ee relative
#ifdef ARTVC_ENABLE_E2EE
RTC_OBJC_EXPORT
@interface ARTVCE2EEParams : NSObject<ARTVCParamsProtocol>
@property(nonatomic,assign) BOOL enableE2EE;  //whether enable e2ee or not, if this is true, the next E2EEIkm must be set
@property(nonatomic,copy) NSString* e2EEIkm;    //e2ee customer ikm, the input key material for create the crypto key
@end
#endif
...
#ifdef ARTVC_ENABLE_E2EE
@property(nonatomic,strong) ARTVCE2EEParams* e2EEParams;
#endif
...
//default is ARTVCAudioSourceType_Mic
@property(nonatomic,assign) ARTVCAudioSourceType audioSource;
...
@property(nonatomic,assign) ARTVCAudioSourceType audioSourceType;//default is ARTVCAudioSourceType_Mic
@property(nonatomic,strong) ARTVCAudioFrameFormat *customAudioFrameFormat;
@end
